      ...
      body: SafeArea(
        ...
        child: BlocConsumer<ProfileBloc, ProfileState>(
          listener: (context, state) {
            if (state is UpdateDescriptionFailed) {
          ...
          builder: (context, state) {
            if (state is UpdateDescriptionLoading) {
              return Center(
            ...
            return Column(
              children: [
                ...
                Expanded(
                  child: UpdateDescriptionForm(
                    onUpdated: (newDescription) {
                      bloc.add(UpdateDescription(description: newDescription));
                    },
                    initialValue: bloc.influencer.description,
                  ),
                ),
              ],
            );
