                  ...
                  Builder(builder: (context) {
                    ...
                    if (summaries.isEmpty) {
                      return Expanded(
                        child: Stack(
                          children: [
                            // RefreshIndicator needs a scrollable child (ListView here).
                            // We keep it empty but always scrollable to allow pull-to-refresh.
                            RefreshIndicator(
                              ...
                              child: ListView(
                                ...
                                children: const [], // empty content, only used for scroll/refresh
                              ),
                            ),
                            // The centered content is placed in a Stack overlay.
                            // This makes sure it stays fixed in the center even while pulling.
                            Center(
                              child: Column(
