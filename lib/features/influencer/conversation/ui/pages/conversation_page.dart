...
class ConversationPage extends StatefulWidget {
  ...
  const ConversationPage(
      {super.key, required this.conversationId, required this.companyName, required this.companyProfilePicture});
                      ...
                      ClipRRect(
                        ...
                        child: Image(
                          ...
                          image: CachedNetworkImageProvider(
                            "$kEndpoint/influencer/get-company-profile-picture/${widget.companyProfilePicture}",
                            headers: {"Authorization": "Bearer $kJwt"},
                          ),
                        ),
                      ),
                      const SizedBox(width: kPadding10),
                      Text(widget.companyName, style: kTitle2),
                      const Spacer(),
                    ],
                  ),
    ...
    return Expanded(
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          final isMine = message.senderType == "influencer";
